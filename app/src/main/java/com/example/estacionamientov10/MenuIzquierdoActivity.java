...
import com.example.estacionamientov10.databinding.ActivityMenuIzquierdoBinding;

public class MenuIzquierdoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                ...
                .build();
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_menu_izquierdo);
